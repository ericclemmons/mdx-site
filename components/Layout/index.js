...
export const Layout = props => (
  <div className="antialiased font-serif text-gray-800">
    ...
    <div class="hidden md:block bg-gray-100 w-1/2 h-screen fixed right-0 z-0" />

    <div class="md:flex mx-auto z-10 relative md:max-w-4xl">
      <div class="md:w-64">
        <nav
          class="md:fixed md:w-64 p-8 md:p-4 text-white"
          style={{
