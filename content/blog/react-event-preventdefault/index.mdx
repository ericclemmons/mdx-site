...
I hope this is more of an edge-case due to our forms \*actually submitting when the user presses **Enter\***, and not a situation others come across unwittingly.
