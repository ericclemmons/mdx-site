...
Although, when you think about it, **this is already how PHP & server-side rendering works**: the request comes in, the view references the current state of the request (e.g. _\$\_GET_ & _\$\_POST_), returns the output, rinse & repeat.
