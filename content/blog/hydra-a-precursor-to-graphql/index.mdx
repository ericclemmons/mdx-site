...
Today, we recognize & leverage GraphQL as the architectural successor to what we needed a few years earlier: **\*a performant, version-less API centered around the needs of individual views**, not their aggregat\*e.
